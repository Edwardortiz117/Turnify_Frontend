...
export function DashboardPage() {
  ...
  return (
    <div>
      ...
      {slug ? (
        <div className="mb-4 flex flex-col gap-1 rounded-xl border border-border/80 bg-card/90 px-4 py-3 shadow-sm shadow-slate-900/[0.04] backdrop-blur-xl backdrop-saturate-150 sm:flex-row sm:items-center sm:justify-between sm:px-5 glass-panel">
          <div>
